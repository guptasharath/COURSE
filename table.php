...
<!--				<a href="login.html">Log out</a>   -->
		...
		<div id="navigation">
			<ul>
			    <li><a href="table.php" class="active"><span>Dashboard</span></a></li>
				<li><a href="table2.php" class=""><span>Saved Courses</span></a></li>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">
							...
							<?php
								while($row = mysql_fetch_array($retval))
									...
									{ 	
										$pipedd=$row["course_name"];
									 echo "<tr>
									 
									 <td>".$row["course_id"]."</td>
									 <td>".$row["course_name"]."</td>
									 <td>".$row["course_type"]."</td> 
									 <td><a text-decoration: bold; href='save.php?course_name=$pipedd'> Save</a></td>
									 "?>
									 <?php
									 "</tr>";
									}
